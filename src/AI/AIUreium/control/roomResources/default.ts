...
import { StructureResourceLimit, RoomResourceLimit } from "../constants/type";

export function transferList<T extends ResourceConstant>(setting: { min: number; max: number }, resList: readonly T[]) {
    const a = {};
